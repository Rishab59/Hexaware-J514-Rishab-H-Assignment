...
public class Loan {
    ...
    public String toString() {
        return "Loan ID: " + loanId + ", Customer ID: " + customer.getCustomerId() + ", Principal: " + principalAmount + ", Interest Rate: " + interestRate + ", Term: " + loanTerm + " months, Type: " + loanType + ", Status: " + loanStatus;
    }
